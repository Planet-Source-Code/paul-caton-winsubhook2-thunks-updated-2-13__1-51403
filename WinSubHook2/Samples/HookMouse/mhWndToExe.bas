...
Private Declare Function GetModuleBaseName Lib "psapi" Alias "GetModuleBaseNameA" (ByVal hProcess As Long, ByVal hModule As Long, ByVal lpFileName As String, nSize As Long) As Long
Private Declare Function GetWindowThreadProcessId Lib "user32" (ByVal hWnd As Long, lpdwProcessId As Long) As Long
Private Declare Function OpenProcess Lib "kernel32" (ByVal dwDesiredAccess As Long, ByVal bInheritHandle As Long, ByVal dwProcessId As Long) As Long

Public Function ExeName(ByVal hWnd As Long) As String
...
Const MAX_PATH      As Long = 260
  ...
  If hProcess Then
    ...
    nRet = GetModuleBaseName(hProcess, hModules(nBaseModule), sBuffer, MAX_PATH)
    
    If nRet Then
      ExeName = Left$(sBuffer, nRet)
    End If
